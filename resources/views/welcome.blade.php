  ...
  <section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Browse our latest rental listings</p>
        </div>

        <div class="row g-4">
            @forelse ($forRentProperties as $rental)
                <div class="col-md-6 col-lg-4">
                    <div class="card h-200 mb-4 shadow-sm border-0 rounded-3 overflow-hidden">
                        <a href="{{ route('property.single', $rental->id) }}">
                            <img src="/images/placeholder.jpg"
                             data-src="{{ asset(ltrim($rental->image, '/')) }}"
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-1">
                                <i class="bi bi-geo-alt"></i> {{ $rental->address }}, {{ $rental->country }}
                            </p>
                            <h6 class="text-success fw-bold mb-3">
                                ₦{{ number_format($rental->price, 2) }}
                            </h6>
                            <a href="{{ route('property.single', $rental->id) }}" class="btn btn-primary btn">
                                View Details
                            </a>
                        </div>
                    </div>
            ...
            @empty
                <p class="text-center text-muted">No properties currently available for rent.</p>
            @endforelse
        </div>
    </div>
 </section>
                ...
                <div class="col-12">
                    ...
                    <div class="wrap-neighborhoods">
                        <div class="box-location hover-img item-1">
                            <div class="image-wrap">
                                <a href="#">
                                    <img class="lazyload" data-src="/assets/images//section/location-9.jpg"
                                        src="/assets/images//section/location-9.jpg" alt="">
                                </a>
                        ...
                        <div class="box-location hover-img item-2">
                            <div class="image-wrap">
                                <a href="#">
                                    <img class="lazyload" data-src="/assets/images//section/location-10.jpg"
                                        src="/assets/images//section/location-10.jpg" alt="">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="text-white">New York</h6>
                                <a href="#" class="text-1 tf-btn style-border pd-23 text-white">2.491 Properties
                        ...
                        <div class="box-location hover-img item-3">
                            <div class="image-wrap">
                                <a href="#">
                                    <img class="lazyload" data-src="/assets/images//section/location-11.jpg"
                                        src="/assets/images//section/location-11.jpg" alt="">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="text-white">New York</h6>
                        ...
                        <div class="box-location hover-img item-4">
                            <div class="image-wrap">
                                <a href="#">
                                    <img class="lazyload" data-src="/assets/images//section/location-12.jpg"
                                        src="/assets/images//section/location-12.jpg" alt="">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="text-white">New York</h6>
                        ...
                        <div class="box-location hover-img item-5">
                            <div class="image-wrap">
                                <a href="#">
                                    <img class="lazyload" data-src="/assets/images//section/location-13.jpg"
                                        src="/assets/images//section/location-13.jpg" alt="">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="text-white">New York</h6>
                        ...
                        <div class="box-location hover-img item-6">
                            <div class="image-wrap">
                                <a href="#">
                                    <img class="lazyload" data-src="/assets/images//section/location-14.jpg"
                                        src="/assets/images//section/location-14.jpg" alt="">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="text-white">New York</h6>
                        ...
                        <div class="box-location hover-img item-7">
                            <div class="image-wrap">
                                <a href="#">
                                    <img class="lazyload" data-src="/assets/images//section/location-15.jpg"
                                        src="/assets/images//section/location-15.jpg" alt="">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="text-white">New York</h6>
                            ...
                            <div class="swiper-slide">
                                <div class="box-house hover-img style-list">
                                    <div class="image-wrap">
                                        <a href="{{ route('property.single', $property->id) }}">
                                            <img class="lazyload"
                                                 data-src="{{ asset($property->image) }}"
                                                 src="{{ asset('images/placeholder.jpg') }}"
                                                 alt="{{ $property->title }}">
                                        </a>
                                        <ul class="box-tag flex gap-8">
                                            <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                {{ ucfirst($property->status ?? 'For Sale') }}
                                            </li>
                                        </ul>
                                        <div class="list-btn flex gap-8">
                                            ...
                                            <a href="{{ route('property.single', $property->id) }}" class="btn-icon find hover-tooltip">
                                    ...
                                    <div class="content">
                                        <h5 class="title">
                                            <a href="{{ route('property.single', $property->id) }}">{{ $property->title }}</a>
                                        </h5>
                                        <p class="location text-1 line-clamp-1">
                                            <i class="icon-location"></i> {{ $property->address }}, {{ $property->country }}
                                        </p>
                                        ...
                                        <ul class="meta-list flex">
                                            <li class="meta-item">
                                                <div class="text-9 flex"><i class="icon-bed"></i>Beds<span>{{ $property->bedrooms ?? '-' }}</span></div>
                                                <div class="text-9 flex"><i class="icon-sqft"></i>Sqft<span>{{ $property->sqft ?? 'N/A' }}</span></div>
                                            </li>
                                            <li class="meta-item">
                                                <div class="text-9 flex"><i class="icon-bath"></i>Baths<span>{{ $property->bathrooms ?? '-' }}</span></div>
                                                <div class="text-9 flex"><i class="icon-garage"></i>Garage<span>{{ $property->garage ?? '-' }}</span></div>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="bot flex justify-between items-center">
                                            ...
                                            <div class="wrap-btn flex">
                                                <a href="{{ route('property.single', $property->id) }}" class="tf-btn style-border pd-4">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="swiper brand-slide " data-preview="6" data-tablet="4" data-mobile-sm="3"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="partner-item style-2">
                                            <svg width="130" height="49" viewBox="0 0 130 49"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="partner-item style-2">
                                            <svg width="148" height="38" viewBox="0 0 148 38"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="partner-item style-2">
                                            ...
                                            <svg width="126" height="75" viewBox="0 0 126 75"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="partner-item style-2">
                                            <svg width="153" height="30" viewBox="0 0 153 30"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="partner-item style-2">
                                            <svg width="86" height="82" viewBox="0 0 86 82"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-12">
                            <div class="content">
                                ...
                                <div class="person wow animate__fadeInRight animate__animated"
                                    ...
                                    <img src="/assets/images//section/person-1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
