<x-app-layout>
    ...
    <div class="main-content w-100">
        <div class="main-content-inner">
            ...
            <form class="box-info-property" action="{{ route('admin.update.property', $property->id) }}" method="POST"
                enctype="multipart/form-data"> @csrf
                <img src="{{ $property->image }}" class="col-4" alt="">
                ...
                <div class="widget-box-2 mb-20">
                    ...
                    <fieldset class="box box-fieldset">
                        ...
                        <textarea class="textarea" name="description">{{ $property->description }}</textarea>
                    </fieldset>
                ...
                <div class="box-btn">
                    <button class="tf-btn bg-color-primary pd-13">Update-Property</button>
                </div>
            </form>
            <!-- .footer-dashboard -->
