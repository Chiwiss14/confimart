...
<!-- Mirrored from themesflat.co/html/proty/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Dec 2024 13:55:09 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/jqueryui.min.css" />
...
<body class="bg-dashboard">
    ...
    <div id="wrapper" class="bg-4 ">
        ...
        <!-- .header -->
        <header id="header-main" class="header dashboard">
                            ...
                            <div class="header-inner-wrap">
                                    ...
                                    <ul class="navigation ">
                                        ...
                                        <li class="has-child  current-menu"><a href="#">Pages</a>
                                            <ul class="submenu">
                                                ...
                                                <li class="current-item"><a href="dashboard.html">Dashboard</a></li>
                                            </ul>
                                        </li>
                                ...
                                <div class="header-right">
                                    ...
                                    <div class="box-user tf-action-btns">
                                        ...
                                        <div class=" menu-user">
                                            <a class="dropdown-item current" href="dashboard.html">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
