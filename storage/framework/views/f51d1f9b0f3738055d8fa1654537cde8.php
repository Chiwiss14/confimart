...
<?php $component->withAttributes([]); ?>
  ...
  <section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $forRentProperties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rental): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-6 col-lg-4">
                    <div class="card h-200 mb-4 shadow-sm border-0 rounded-3 overflow-hidden">
                        <a href="<?php echo e(route('property.single', $rental->id)); ?>">
                            <img src="/images/placeholder.jpg"
                             data-src="<?php echo e(asset(ltrim($rental->image, '/'))); ?>"

                                 class="card-img-top"
                                 alt="<?php echo e($rental->title); ?>"
                                 style="height: 220px; object-fit: cover;">
                        </a>
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e($rental->title); ?></h5>
                            <p class="card-text text-muted mb-1">
                                <i class="bi bi-geo-alt"></i> <?php echo e($rental->address); ?>, <?php echo e($rental->country); ?>

                            </p>
                            <h6 class="text-success fw-bold mb-3">
                                ₦<?php echo e(number_format($rental->price, 2)); ?>

                            </h6>
                            <a href="<?php echo e(route('property.single', $rental->id)); ?>" class="btn btn-primary btn">
                                View Details
                            </a>
                        </div>
                    </div>
