                        ...
                        <div class="col-12">
                            <div class="wrap-image">
                                <div class="image img-1">
                                    <a href="/assets/images/section/property-detail-3.jpg" data-fancybox="gallery"
                                        class="image-wrap relative d-block">
                                        <img class="lazyload" data-src="/assets/images/section/property-detail-3.jpg"
                                            src="/assets/images/section/property-detail-3.jpg" alt="">
                                    </a>
                                ...
                                <div class="wrap-image-right">
                                    <div class="image img-2">
                                        <a href="/assets/images/section/property-detail-4.jpg" data-fancybox="gallery"
                                            class="image-wrap relative d-block">
                                            <img class="lazyload" data-src="/assets/images/section/property-detail-4.jpg"
                                                src="/assets/images/section/property-detail-4.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="bot">
                                        <div class="image img-3">
                                            <a href="/assets/images/section/property-detail-5.jpg" data-fancybox="gallery"
                                                class="image-wrap relative d-block">
                                                <img class="lazyload" data-src="/assets/images/section/property-detail-5.jpg"
                                                    src="/assets/images/section/property-detail-5.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="image img-4">
                                            <a href="/assets/images/section/property-detail-6.jpg" data-fancybox="gallery"
                                                class="image-wrap relative d-block">
                                                <img class="lazyload" data-src="/assets/images/section/property-detail-6.jpg"
                                                    src="/assets/images/section/property-detail-6.jpg" alt="">
                                            </a>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class=" wg-property video">
                                ...
                                <div class="widget-video">
                                    <img class="lazyload" data-src="/assets/images/section/property-detail.jpg"
                                        src="/assets/images/section/property-detail.jpg" alt="">
                                ...
                                <ul class="box-floor" id="parent-floor">
                                    <li class="floor-item">
                                        ...
                                        <div id="floor-one" class="collapse show" data-bs-parent="#parent-floor">
                                            <div class="faq-body">
                                                <div class="box-img">
                                                    <img src="/assets/images/section/floor.jpg" alt="img-floor">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="wg-property box-attachments">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="#" target="_blank" class="attachments-item">
                                            <div class="box-icon w-60">
                                                <img src="/assets/images/items/download-1.png" alt="file">
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <a href="#" target="_blank" class="attachments-item">
                                            <div class="box-icon w-60">
                                                <img src="/assets/images/items/download-2.png" alt="file">
                                            </div>
                                            <span>Villa-Document.pdf</span>
                                            <i class="icon icon-DownloadSimple"></i>
                                        </a>
                            ...
                            <div class="wg-property box-virtual-tour">
                                ...
                                <div class="image-wrap">
                                    <img src="/assets/images/section/property-detail-2.jpg" alt="">
                                    <div class="box-icon">
                                        <div class="icons">
                                            <i class="icon-360"></i>
                                        </div>
                            ...
                            <div class="wg-property mb-0 box-comment">
                                ...
                                <div class="box-send ">
                                    ...
                                    <form class="form-add-review" action="<?php echo e(route('review.store')); ?>" method="POST"
                                      enctype="multipart/form-data"> <?php echo csrf_field(); ?>
                                        <div class="cols">
                                            ...
                                            <fieldset class="email">
                                                ...
                                                <input type="email" name="email" class="tf-input style-2" placeholder="Your Email*"
                                        ...
                                        <fieldset class="message">
                                            <label class="text-1 fw-6"
                                            for="message">Review</label>
                            ...
                            <div class=" tf-sidebar sticky-sidebar ">
                                <form class="form-contact-seller mb-30">
                                    ...
                                    <div class="seller-info">
                                        <div class="avartar">
                                            <img src="/assets/images/avatar/seller.jpg" alt="">
                                        </div>
                                        <div class="content">
                                ...
                                <div class=" sidebar-ads mb-30">
                                    <div class="image-wrap">
                                        <img class="lazyload" data-src="/assets/images/blog/ads.jpg" src="/assets/images/blog/ads.jpg"
                                            alt="">
                                    </div>
                                ...
                                <div class="swiper-wrapper tf-layout-mobile-xl  lg-col-3 wrap-agent wow fadeInUp"
                                        ...
                                        <div class="box-house hover-img">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="/assets/images/section/box-house-21.jpg"
                                                        src="/assets/images/section/box-house-21.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="/assets/images/section/box-house-18.jpg"
                                                        src="/assets/images/section/box-house-18.jpg" alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text-white">Featured</li>
                                                    <li class="flat-tag text-4 bg-3 fw-6 text-white">For Sale</li>
                    ...
                    <div class="col-12">
                        <div class="footer-top">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img id="logo_footer" src="/assets/images/logo/logo-2%402x.png" alt="logo-footer">
                                </a>
                            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Desktop\PROJECTS\chief-pro\resources\views/propertylist.blade.php ENDPATH**/ ?>